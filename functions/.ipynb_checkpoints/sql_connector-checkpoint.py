...
class sql_connector:
    ...
    def to_sql(self, dataframe, sql_table_name, sql_schema_name):
        """
        ...
        dataframe.to_sql(name = sql_table_name, schema = sql_schema_name, con = self.engine, 
                         index = False, if_exists = "replace", chunksize = chunksize, method = "multi")